...
function em_url($replace, $EM_Event, $result){
    if( $result == '#_EMURL' ){
		...
		if(get_field('registration_link', $id)):
			...
			$replace = '<a id="register-btn" target="_blank" href="' .get_field('registration_link', $id ). '">More Info/Register</a>';
		else: 
			$replace = '';
