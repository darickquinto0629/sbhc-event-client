...
- Modified Ticket Price field type from numeric to text input to support flexible pricing options (price ranges, promotional messaging, and non-numeric values such as "Free" or "Donation")
